const dialogueMap = {
    ...
    "bridge_start": {
        "conversation": [
            ...
            {"speaker": "Me", "text": "WHAT?", speed: 40},
            {"speaker": "Me", "text": "WHAT DO YOU MEAN YOU DON'T KNOW WHERE HE IS?", speed: 50},
            {"speaker": "Me", "text": "ISN'T HE SUPPOSED TO BE MANAGING THIS ALL??", speed: 50},
            {"speaker": "Me", "text": "DO YOU KNOW HOW MUCH TIME I'VE BEEN WAITING FOR THIS VACATION???", speed: 60},
            {"speaker": "Construction Worker", "text": [
    ...
    "boss_restaurant": {
        "conversation": [
            ...
            ], pitch: 0.9, autoskip: true, speed: 20},
            { "speaker": "Me", "text": [
